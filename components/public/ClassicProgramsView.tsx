...
const SORT_LABELS: Record<ClassicProgramsSortMode, string> = {
    ...
    <div className="bg-white text-black">
      <div className="relative overflow-hidden border-b border-black/10 bg-[var(--fpn-navy)] text-white">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 80% 60% at 85% 20%, rgba(225,6,0,0.35), transparent 55%), radial-gradient(ellipse 50% 40% at 10% 90%, rgba(255,255,255,0.08), transparent 50%)",
          }}
        />
        <div className="relative mx-auto max-w-[1440px] px-4 py-10 md:px-8 lg:px-10 lg:py-14">
          ...
          <p className="mt-3 max-w-2xl text-sm text-white/70 md:text-base">
            Timeless favorites from FlashPoint Television Network — weekday
            classics you can still catch on the schedule.
          </p>
        ...
        {programs.length === 0 ? (
          <div className="rounded-[12px] border border-dashed border-black/15 px-6 py-16 text-center">
            <h2 className="font-article text-2xl font-black tracking-tight">
              No classic programs listed
            </h2>
            <p className="mx-auto mt-2 max-w-md text-sm text-black/60">
              Check back soon for the weekday lineup, or browse the latest news.
            </p>
            <Link
              href="/"
